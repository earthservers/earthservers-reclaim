  ...
  return (
    <div className="flex items-center gap-2 px-3 py-2 bg-gray-800 border-b border-gray-700">
      ...
      <div className="flex-1 flex items-center gap-2 px-3 py-1.5 bg-gray-900 border border-gray-600 rounded-lg">
        ...
        {/* Favorite (pin) — distinct from the bookmark star: pins, caches & indexes
            the page. Single source of truth with the History/search-result pins. */}
        {isExternalUrl(currentUrl) && (
          <FavoriteStar url={currentUrl} profileId={profileId} className="p-1" />
        )}
      </div>
